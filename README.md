# Reto de Automatización de Pruebas - Hexacta

### Comando para la Ejecución

Ejecutar Runner específico:

    gradlew.bat clean test --tests co.com.proyectobase.screenplay.runners.RunnerTags aggregate -i
...
Para la ejecución desde un equipo Windows es necesario modificar el archivo serenity.properties y agregar # para comentar la línea que usa el driver de chrome para Mac, así:
comentar esta: #webdriver.chrome.driver=src/test/resources/driver/chromedriver

y eliminar el # para habilitar el driver de chrome para Windows
webdriver.chrome.driver=src/test/resources/driver/chromedriver.exe

Actualizar la version de chromedriver en caso que la máquina de ejecución lo requiera
